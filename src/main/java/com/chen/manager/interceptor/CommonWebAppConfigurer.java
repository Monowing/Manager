...
public class CommonWebAppConfigurer implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	InterceptorRegistration r1 = registry.addInterceptor(commonInterceptor()).addPathPatterns("/**");
...
//        super.addInterceptors(registry);
   ...
   /* @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler(staticAccessPath).addResourceLocations("file:" + uploadFolder+"upload/");
    }*/
